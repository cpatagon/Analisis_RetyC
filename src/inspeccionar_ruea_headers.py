...
----------------------------------
Escanea `descargas_retc/` para archivos `ruea-efp-*-ckan.csv` y `ruea-efp-*-ckan.xlsx`,
detecta codificación (CSV) y separador, extrae encabezados y genera:

1) datos/filtrados_region/diagnostico_headers.csv
2) datos/filtrados_region/columnas_distintas_map.csv
3) datos/filtrados_region/columnas_normalizadas_vocab.csv
